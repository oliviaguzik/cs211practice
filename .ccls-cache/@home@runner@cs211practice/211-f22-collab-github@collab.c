...
void oguzi2_mturc3(){
  printf("Olivia Guzik and  Mykola Turchak\n");
  printf("We learned how to properly clone the git repo with the given link. Additionaly, this process showed us how to push the changes and store them.\n");
}
